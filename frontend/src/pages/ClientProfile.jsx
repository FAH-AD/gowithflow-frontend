              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${profileData?.isEmailVerified
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs ${profileData?.clientVerification.status === "verified"
                        ? "bg-green-500/20 text-green-500"
                        : "bg-yellow-500/20 text-yellow-500"
                        }`}
                    >
