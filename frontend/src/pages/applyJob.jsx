  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-12">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Job Details */}
        {job && (
          <div className="bg-white border-slate-200 mb-8">
                    ...
                    {job.crowdsourcingRoles.map((role, index) => (
                      <div
                        ...
                        className={`p-4 rounded-lg border cursor-pointer transition-all ${applicationData.role === role.title
                          ...
                          : "border-[#2d2d3a] bg-slate-100 hover:border-[#12a1e2]/50"
                          }`}
                        onClick={() => {
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">How long will it take you to complete this project?</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div
                  className={`border-2 border-dashed rounded-lg p-6 text-center ${dragActive ? "border-[#12a1e2] bg-[#12a1e2]/5" : "border-[#2d2d3a]"
                    }`}
                  ...
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <button
                      ...
                      className={`mt-4 px-4 py-2 rounded-md cursor-pointer transition-colors ${uploadingFiles
                        ? "bg-[#1e1e2d] text-slate-500 cursor-not-allowed"
            ...
            <div className="p-6 border-b border-[#2d2d3a]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-slate-500 mt-1">Break down your project into manageable milestones</p>
                </div>
                <button
                  type="button"
                  onClick={addMilestone}
                  className="flex items-center gap-2 bg-[#12a1e2] hover:bg-[#0e8cd4] text-white px-4 py-2 rounded-md transition-colors"
                >
                  <Plus size={18} />
