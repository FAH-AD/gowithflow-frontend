          ...
          <div className="flex items-center w-full max-w-md">
            {[1, 2, 3, 4, 5].map((step, index, array) => (
              <React.Fragment key={step}>
                <motion.div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= step ? "bg-purple-700" : "bg-gray-700"
                    }`}
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <motion.input
                    ...
                    required
                    className={`w-full px-4 py-3 bg-gray-800 border ${fieldErrors.location ? "border-red-500" : "border-gray-700"
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                  />
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <motion.input
                    ...
                    required
                    className={`w-full px-4 py-3 bg-gray-800 border ${fieldErrors.title ? "border-red-500" : "border-gray-700"
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <motion.textarea
                    ...
                    rows="4"
                    required
                    className={`w-full px-4 py-3 bg-gray-800 border ${fieldErrors.bio ? "border-red-500" : "border-gray-700"
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                  ></motion.textarea>
                ...
                <div className="space-y-2">
                  ...
                  <motion.input
                    ...
                    min="1"
                    required
                    className={`w-full px-4 py-3 bg-gray-800 border ${fieldErrors.hourlyRate ? "border-red-500" : "border-gray-700"
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <motion.select
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full px-4 py-3 bg-gray-800 border ${fieldErrors.availability ? "border-red-500" : "border-gray-700"
                      } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <motion.input
                      ...
                      className={`flex-1 px-4 py-3 bg-gray-800 border ${fieldErrors.skills ? "border-red-500" : "border-gray-700"
                        } rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all duration-200`}
                    />
                    <motion.button
                      type="button"
