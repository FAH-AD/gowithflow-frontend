...
const HireOffers = () => {
  ...
  useEffect(() => {
    if (!user) {
      navigate("/login", {
        state: { from: "/member/hire-offers", message: "Please login to view your offers" },
      })
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex border-b border-[#2d2d3a] mb-6">
          <button
            ...
            className={`px-6 py-3 font-medium text-sm ${activeTab === "regular" ? "border-b-2 border-[#9333EA] text-white" : "text-gray-400 hover:text-white"
              }`}
          >
            Regular Jobs
          </button>
          <button
            ...
            className={`px-6 py-3 font-medium text-sm flex items-center ${activeTab === "team" ? "border-b-2 border-[#9333EA] text-white" : "text-gray-400 hover:text-white"
              }`}
          >
