              ...
              <div className="space-y-2">
                {teams.map((team) => (
                  <motion.div
                    ...
                    className={`p-3 rounded-lg cursor-pointer transition-all ${selectedTeam?._id === team._id
                    ...
                    {selectedTeam.team.length === 0 ? (
                      ...
                      selectedTeam.team.map((member) => (
                        <motion.div
                          ...
                          className={`p-3 rounded-lg cursor-pointer transition-all ${selectedMember?._id === member._id
                            ? "bg-[#9333EA]/20 border border-[#9333EA]/50"
                            : "hover:bg-[#2d2d3a]"
                            }`}
                        >
                                  ...
                                  <div className="mt-3 p-3 bg-[#1c1c24] rounded-lg">
                                    ...
                                    <div className="mt-3 flex justify-end gap-2">
                                      ...
                                      <button
                                        ...
                                        className={`bg-green-600 text-white px-3 py-1 rounded-md text-sm hover:bg-green-700 transition-colors flex items-center ${approvingMilestoneId === milestone._id
